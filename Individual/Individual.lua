...
SelectBot = function(key, silent)
    ...
    -- CB_FetchStats handles its own deduplication internally: an in-flight guard
    -- (awaitingMoney) blocks rapid bursts, and a 30s TTL (STATS_TTL) prevents spam
    -- when re-selecting or clicking the same bot.
    local entry = CleanBot_PartyBots[slot.key]
